...
dependencies {
    ...
    // Crash reporting — GlitchTip (Sentry-compatible SDK, manual init)
    // implementation("io.sentry:sentry-android-core:8.36.0") // stripped for release build
