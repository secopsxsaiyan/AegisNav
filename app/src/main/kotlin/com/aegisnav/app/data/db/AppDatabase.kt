...
@Database(
    ...
    version = 28,          // 17→18 (baseline) | 18→19 (police dist) | 19→20 (following_events) | 20→21 (trackerType, permanent) | 21→22 (beacon_sightings) | 22→23 (debug_log) | 23→24 (police deviceCount/deviceMacs consolidation) | 24→25 (officer_units, sighting verdict/officerUnitId) | 25→26 (officer_units verdict locking) | 26→27 (officer_units lastConfirmTimestamp) | 27→28 (watchlist)
    exportSchema = true
)
